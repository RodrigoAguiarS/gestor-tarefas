...
public class CategoriaController extends ControllerBase<CategoriaResponse> {
    ...
    @GetMapping
    public ResponseEntity<Page<CategoriaResponse>> consultarTodos(Pageable pageable) {
        Page<CategoriaResponse> categoriaResponses = categoriaService.listarTodos(pageable);
        return responderListaDeItensPaginada(categoriaResponses);
    }
}